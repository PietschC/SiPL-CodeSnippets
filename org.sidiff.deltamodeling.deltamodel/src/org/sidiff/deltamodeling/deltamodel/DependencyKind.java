 ...
 * <!-- end-user-doc -->
 * @see org.sidiff.deltamodeling.deltamodel.DeltaModelPackage#getDependencyKind()
 * @model
 * @generated
 */
public enum DependencyKind implements Enumerator {
	 ...
	 * @ordered
	 */
	CHANGE_CHANGE(8, "ChangeChange", "ChangeChange"), /**
	 ...
	 * @ordered
	 */
	DANGLING_DEPENDENCY(9, "DanglingDependency", "DanglingDependency");
	 ...
	 * @ordered
	 */
	public static final int CHANGE_CHANGE_VALUE = 8;
	 ...
	 * @ordered
	 */
	public static final int DANGLING_DEPENDENCY_VALUE = 9;
